...
from .views_user import PartnershipViewSet, ProductViewSet, RequestFormViewSet, ProjectReferenceViewSet, NewsViewSet, ArticleViewSet
from .views_admin import AdminPartnershipViewSet, AdminProductViewSet, AdminRequestFormViewSet, AdminProjectReferenceViewSet, AdminNewsViewSet, AdminArticleViewSet
